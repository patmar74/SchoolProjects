...
Public Class LanderClient
    'Tcp Public Variables
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'Msgbox to connect to host
        Dim hostIp As String = "Nothing"
        Dim Message As String = "Enter host Ip"
        Dim Title As String = "Client"
        Dim ipInput As Object

        ipInput = InputBox(Message, Title)
        hostIp = ipInput.ToString
        'MessageBox.Show("Welcome to Lunar Lander, Use Up to Thrust, and Left/Right to Rotate", "Directions") ' Display Directions, also allows wait til network connection is made
        Debug.Print(hostIp)

        'Use hostIp to connect to host
        TCPClientz = New Sockets.TcpClient(hostIp, 1000) 'Change port here
    ...
    Private Sub TimerRec_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles timerRec.Tick
        ...
        sendBytes = System.Text.Encoding.ASCII.GetBytes(landerLocation.X & " " & landerLocation.Y)
